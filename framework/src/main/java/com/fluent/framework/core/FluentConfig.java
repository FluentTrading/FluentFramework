...
public class FluentConfig{
    ...
    private final static String NAME                        = FluentConfig.class.getSimpleName();
    private final static Logger LOGGER                      = LoggerFactory.getLogger( NAME );

    
    public FluentConfig( String configFileName ) throws Exception{
    ...
    public final String getApplicationInfo( ){
        ...
        builder.append( ", Process:" ).append( IOUtils.getFullProcessName( ) );
    ...
    protected final Config loadConfigs( String fileName ){
        ...
        try{
            LOGGER.info("Attempting to load config from file {}", fileName );
